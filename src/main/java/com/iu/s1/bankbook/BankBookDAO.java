...
public class BankBookDAO {
	...
	public Long getBankBookCount(Pager pager) throws Exception{
		Long result = sqlSession.selectOne(NAMESPACE+"getBankBookCount");
	...
	public BankBookDTO getBankBookDetail(BankBookDTO bankBookNum) throws Exception{
		return sqlSession.selectOne(NAMESPACE+"getBankBookDetail", bankBookNum);
	}
