...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row justify-content-center my-4">
			<h1 class="col-md-7 text-center">${boardName}UpdatePage</h1>
		</div>
			...
			<form class="col-md-7" action="./update" method="post"
				...
				<div class="mb-3">
					<label for="title" class="form-label">제목</label> <input type="text"
						name="title" class="form-control" value="${dto.title}" id="title"
						placeholder="제목 입력">
				</div>
				...
				<div class="mb-3">
					...
					<textarea name="contents" class="form-control" id="contents"
						placeholder="내용 입력" rows="7">${dto.contents}</textarea>
				</div>
					...
					<c:forEach items="${dto.boardFileDTOs}" var="fileDTO">
						<div class="input-group mb-3 my-3">
							<div class="input-group-text">
								<input class="form-check-input mt-0 deleteCheck" type="checkbox" value="${fileDTO.fileNum}"  name="fileNum"
									aria-label="Checkbox for following text input">
							</div>
							<input type="text" disabled value="${fileDTO.oriName}" class="form-control"
