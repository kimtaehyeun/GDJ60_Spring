...
<body>
	...
	<div class="container-fluid">
		<c:if test="${not empty dto}">
			...
			<div>
				<c:if test="${not empty dto.bankBookImgDTO}">
					<img alt=""
						src="../resources/upload/bankBook/${dto.bankBookImgDTO.fileName}">
				</c:if>
			</div>
		...
		<a href="./update?bookNumber=${dto.bookNumber}">상품수정</a> <a
			href="./list">목록으로</a>
	</div>

	<div class="my-5" id="commentListResult"></div>
	...
	<div class="my-5">
		...
		<div class="mb-3">
			<button type="button" class="btn btn-primary" id="replyAdd"
				data-book-bookNum="${dto.bookNumber}">댓글작성</button>
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" data-comment-num=""
						id="contentsConfirm">확인</button>
				</div>
			</div>
		</div>
	</div>
